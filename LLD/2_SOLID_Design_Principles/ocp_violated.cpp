...
class ShoppingCartDatabase{
   ...
   public:
    ...
    void saveToMongodb(){
        cout << "Shopping Cart is saved to mongo db sucessfully" << endl;
    }

    void saveToSQLdb(){
        cout << "Shopping Cart is saved to sql db sucessfully" << endl;
    }

    void saveToFile(){
        cout << "Shopping Cart is saved to file sucessfully" << endl;
    }
};
